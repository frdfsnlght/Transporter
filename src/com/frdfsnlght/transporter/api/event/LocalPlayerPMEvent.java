...
/**
 * Fired when a private message is sent to a local player from another local player.
 *
...
public final class LocalPlayerPMEvent extends Event implements Cancellable {
     ...
     */
    public LocalPlayerPMEvent(Player fromPlayer, Player toPlayer, String message) {
    ...
    /**
     * Returns the <code>Player</code> object of the player that sent the message.
     *
     * @return the player
     */
