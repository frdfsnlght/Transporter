...
/**
 * Fired when a remote player is kicked.
 *
 * @author frdfsnlght <frdfsnlght@gmail.com>
 */
public final class RemotePlayerKickEvent extends Event {
     ...
     */
    public RemotePlayerKickEvent(RemotePlayer player) {
        this.player = player;
    }

    /**
     * Returns the {@link RemotePlayer} object of the player that was kicked.
     *
     * @return the player
     */
