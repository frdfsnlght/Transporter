 ...
 */
public class CompatibilityProvider_v1_5_R1 implements CompatibilityProvider {
    ...
    public TypeMap getItemStackTag(ItemStack stack) {
        net.minecraft.server.v1_5_R1.ItemStack nmsStack = CraftItemStack.asNMSCopy(stack);
